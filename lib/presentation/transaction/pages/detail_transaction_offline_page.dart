...
class DetailTransactionOfflinePage extends StatefulWidget {
  final TransactionModel transaction;
  const DetailTransactionOfflinePage({
    super.key,
    required this.transaction,
  });

  @override
  State<DetailTransactionOfflinePage> createState() =>
      _DetailTransactionOfflinePageState();
}

class _DetailTransactionOfflinePageState
    extends State<DetailTransactionOfflinePage> {
  @override
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                      ...
                      children: [
                        Text('Total'),
                        Text(
                            widget.transaction.totalPrice?.currencyFormatRpV3 ??
                                ''),
                      ]),
                  const SizedBox(height: 8),
                  Row(
            ...
            ListView.builder(
              ...
              itemCount: widget.transaction.items?.length ?? 0,
